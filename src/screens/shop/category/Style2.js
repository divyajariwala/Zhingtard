...
class Style2 extends React.Component {
  constructor(props) {
    ...
    const parent = data[0] ? data[0] : null;
    this.state = {
      listParent: data,
      parent,
    };
  ...
  render() {
    ...
    const _listData = parent ? concat(childCategories, parent) : childCategories;
    const listData = excludeCategory(_listData, exclude_categories);
    ...
    return (
      <>
        ...
        {listData.length < 1 ? <EmptyCategory /> : (
